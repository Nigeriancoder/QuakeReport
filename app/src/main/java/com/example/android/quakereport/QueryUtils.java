...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link DataSource} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<DataSource> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<DataSource> earthquakes = new ArrayList<>();
        ...
        try {
           ...
           for (int i = 0; i<features.length(); i++){
               ...
               earthquakes.add(new DataSource(Double.valueOf(mag), location, date, details ));
           }
